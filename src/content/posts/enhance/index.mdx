...
> [!warning]
>
> Setting an image's `width` attribute directly may cause blurriness. [Learn more](https://github.com/ndEX/Litos/discussions/17)
...
```md title=':::image-a.md'
:::image-a{href="https://github.com/ndEX/Litos"}
![OG image](assets/cover.png)
:::

:::image-a{href="https://github.com/ndEX/Litos" style="display:block" .custom-class}
...
Framed images with a border and shadow.
...
**Example 1**: `:link[ndEX]{#@ndEX}` links to the GitHub profile of the project maintainer, :link[ndEX]{#@ndEX}.

**Example 2**: `:link[Vite]{id=@vitejs}` links to the GitHub profile of the :link[Vite]{id=@vitejs} organization.

**Example 3**: `:link{#@ndEX tab=repositories}` links directly to the repositories tab of the GitHub user, like :link{#@ndEX tab=repositories}. For GitHub users, valid `tab` options: `'repositories','projects', 'packages', 'stars', 'sponsoring', 'sponsors'`.
...
**Example 12**: `:link{id=ndEX/Litos class=github}` creates a :link{id=ndEX/Litos class=github} with `class=github` (or `.github`) to override the default style of a GitHub repository.

**Example 13**: `:link[Litos Themes]{id=https://github.com/ndEX/Litos img=https://github.githubassets.com/assets/mona-e50f14d05e4b.png}` fully customizes a link. :link[Litos Themes]{id=https://github.com/ndEX/Litos img=
